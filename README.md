...
Here an empty json objects returned since user doesnt have any tasks. We can add tasks like so:
...
We can do much more and its all well documented within the java docs :) Here is added task!
